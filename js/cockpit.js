window.addEventListener('load', () => {
    ...
    // Initialisation bouton Marche/Arrêt
    ...
    function updatePosition(deltaTime){
        ...
        if(speedData.length>50) speedData.shift();
    }
    ...
    function drawSismograph(){
        ...
        seisCtx.strokeStyle='red'; seisCtx.stroke();
    }
    ...
    // Chart.js graphique vitesse/température
    ...
    // Mise à jour capteurs toutes les secondes
    ...
    function updateAll(){
        ...
        // Météo OpenWeatherMap (remplacer YOUR_API_KEY par ta clé)
        let latC = prevLat ?? 48.8566;
        let lonC = prevLon ?? 2.3522;
        fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latC}&lon=${lonC}&units=metric&appid=YOUR_API_KEY`)
        .then(res=>res.json())
        .then(data=>{
